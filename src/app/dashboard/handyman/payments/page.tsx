...
export default function HandymanPayments() {
  ...
  const { data: payments = [], error, isLoading, mutate } = useSWR<Payment[]>(
    mounted ? '/handyman/transactions/payments' : null,
    fetcher
  );
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-sm text-zinc-400 mt-1">
            Track and monitor all your digital transactions and online customer payments.
          </p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-[#18181b] border border-zinc-800/80 rounded-xl p-5 relative overflow-hidden group">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-xs text-zinc-400 font-medium uppercase tracking-wider">Total Received</p>
        ...
        <div className="bg-[#18181b] border border-zinc-800/80 rounded-xl p-5 relative overflow-hidden group">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-xs text-zinc-400 font-medium uppercase tracking-wider">Pending/Escrow</p>
              <h3 className="text-2xl font-bold text-white mt-1">
        ...
        <div className="bg-[#18181b] border border-zinc-800/80 rounded-xl p-5 relative overflow-hidden group">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-xs text-zinc-400 font-medium uppercase tracking-wider">Total Transactions</p>
              <h3 className="text-2xl font-bold text-white mt-1">
                {stats.count} <span className="text-sm font-normal text-zinc-500">records</span>
              </h3>
            </div>
          </div>
        </div>
                    ...
                    <div className="flex flex-col items-center justify-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-zinc-500 mt-1">
                          We couldn't find any online transactions matching your filters.
                        </p>
                      </div>
                    </div>
                  </td>
